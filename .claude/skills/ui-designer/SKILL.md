---
name: "ui-designer"
description: "视觉与交互设计专家。在需要做 UI 视觉风格、组件视觉规范、设计系统拆解或视觉评审时调用此技能（与 harmonyos-expert 互补）。"
---

## 调用场景（项目内）
- 设计宠物 App 页面的视觉层次、配色与组件规范
- 输出新页面的视觉稿与组件拆解建议
- 与 harmonyos-expert / harmonyos-25d-expert 协同：本技能负责通用 UI 语言，鸿蒙技能负责落地 ArkUI
