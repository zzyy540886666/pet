...
description: "架构审查专家。在需要评估模块边界、依赖方向、可扩展性与重构方向时调用此技能。"
---

## 调用场景（项目内）
- 审查 pages / common (components/models/services/constants) 的层级与依赖
- 2.5D 渲染层、动作状态机、网络层的解耦评审
- 与 refactoring-specialist 协同制定重构路线
